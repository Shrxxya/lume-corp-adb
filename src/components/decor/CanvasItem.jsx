...
const elementGlow = {
  ...
  "Live Band Stage":     "0 0 32px #FDFDF8,  0 0 8px #FDFDF8",
  ...
  "Seating Area":        "0 0 16px #FDFDF8",
  "Audience Block":      "0 0 16px #FDFDF8",
            ...
            <g key={i}>
              {nodes.slice(i + 1).map((other, j) => (
                <line key={j} x1={node.cx} y1={node.cy} x2={other.cx} y2={other.cy}
                  stroke={night ? "rgba(140,200,140,0.25)" : "#FDFDF8"}
                  strokeWidth={1} />
              ))}
              <circle cx={node.cx} cy={node.cy} r={6}
                fill={night ? "rgba(98,200,140,0.7)" : "#FDFDF8"}
                stroke={night ? "rgba(140,255,180,0.5)" : "#FDFDF8"} strokeWidth={1.5} />
            </g>
          ))}
        </svg>
      );
  ...
  return (
      ...
      style={{
        ...
        boxShadow: hovered
          ? (night
              ...
              : "0 8px 32px rgba(20,24,42,0.14), 0 0 0 1.5px #FDFDF8")
          : glow,
        background: bg,
    ...
    >
      ...
      >
        <svg width={14} height={14} viewBox="0 0 14 14">
          <path d="M2 12 L12 2 M6 12 L12 6 M10 12 L12 10"
            stroke={night ? "rgba(255,255,255,0.7)" : "#FDFDF8"}
      ...
      <div
        ...
        style={{
          background: night ? "#FDFDF8" : "#FDFDF8",
