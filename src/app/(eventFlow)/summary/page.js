...
function Divider() {
  return (
    <div className="w-full h-px my-8" style={{ background: "linear-gradient(90deg, transparent, rgba(98,117,76,0.3), transparent)" }} />
  );
}
...
function SectionLabel({ children }) {
  return (
    <motion.span
      ...
      style={{
        background: "rgba(98,117,76,0.12)",
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: "1px solid rgba(98,117,76,0.18)",
      ...
      >
        <div className="relative flex items-center justify-center">
          <motion.div
            ...
            style={{ background: "radial-gradient(circle, rgba(98,117,76,0.6), transparent 70%)" }}
            animate={{ scale: [1, 1.4, 1], opacity: [0.6, 0.2, 0.6] }}
            transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="w-14 h-14 rounded-full border-2 border-transparent"
            style={{ borderTopColor: "var(--color-primary)", borderRightColor: "rgba(98,117,76,0.3)" }}
            animate={{ rotate: 360 }}
        ...
        <div className="max-w-5xl mx-auto px-6 pb-15 space-y-22">
                  ...
                  <Reveal key={v.uid} delay={i * 0.08}>
                    <motion.div
                      ...
                      style={{
                        ...
                        backdropFilter: "blur(20px)",
                        border: "1px solid rgba(98,117,76,0.15)",
                  ...
                  {summaryData.timeline.map((event, i) => (
                    <Reveal key={i} delay={i * 0.06}>
                      <div className="flex items-center gap-6">
                        ...
                        {/* dot */}
                        <div className="w-3 h-3 rounded-full flex-shrink-0 ring-4" style={{ background: "var(--color-primary)", ringColor: "rgba(98,117,76,0.15)" }} />
                        <motion.div
                          whileHover={{ x: 4 }}
                          ...
                          style={{
                            background: "rgba(253,253,248,0.7)",
                            backdropFilter: "blur(12px)",
                            border: "1px solid rgba(98,117,76,0.12)",
                          }}
                        >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <motion.div
                      ...
                      style={{ background: "rgba(20,24,42,0.04)", border: "1px solid rgba(98,117,76,0.12)" }}
                    >
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <motion.button
                      whileHover={{ scale: 1.03, boxShadow: "0 0 40px rgba(98,117,76,0.5)" }}
                      whileTap={{ scale: 0.97 }}
                      onClick={async () => {
                        if (isGenerating || isSending) return;
                        const url = await generatePdfIfNeeded();
          ...
          <AnimatePresence>
            {showQR && pdfUrl && (
              ...
              >
                <motion.div
                  animate={{ boxShadow: ["0 0 0px rgba(98,117,76,0.3)", "0 0 40px rgba(98,117,76,0.5)", "0 0 0px rgba(98,117,76,0.3)"] }}
      ...
      <AnimatePresence>
        {showPaymentSuccess && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md">
            ...
            >
              <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-72 h-72 rounded-full" style={{ background: "radial-gradient(circle, rgba(98,117,76,0.2), transparent 70%)", filter: "blur(30px)" }} />
              ...
              <motion.div
                ...
                style={{ background: "linear-gradient(135deg, var(--color-primary), #8BA672)", boxShadow: "0 12px 40px rgba(98,117,76,0.4)" }}
              >
              ...
              <div className="rounded-2xl p-5 space-y-3 mb-8" style={{ background: "rgba(98,117,76,0.06)", border: "1px solid rgba(98,117,76,0.15)" }}>
                {[
                ...
                <div className="flex justify-between items-center pt-2" style={{ borderTop: "1px solid rgba(98,117,76,0.15)" }}>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="w-full py-4 rounded-2xl text-white font-semibold flex items-center justify-center gap-2"
                  style={{ fontFamily: "var(--font-body)", background: "linear-gradient(135deg, var(--color-primary), #7E9564)", boxShadow: "0 8px 32px rgba(98,117,76,0.35)" }}
                >
                  <Download size={16} />
                  Download Receipt
                </button>
